...
- **Projections, regenerable:** `memory/active_memory.md`, `journal/`, `snapshots/`. Deterministic (or freely re-runnable) functions of the log and facts. Free to overwrite.
